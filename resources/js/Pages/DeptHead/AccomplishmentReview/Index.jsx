...
export default function Index() {
    return (
        <AppLayout title="Accomplishment Review">
            <div style={card}>
                ...
                <h4 style={h}>Accomplishment Review</h4>
                <p style={p}>Review and rate accomplishment submissions from employees in your department.</p>
                        <div style={{badgesStyle}}><span style={{badgeStyle}}>Review</span>
