...
export default function Index() {
    ...
    const pendingCount = submissions.filter(s => s.status === 'supervisor_endorsed').length;
    ...
    return (
        <AppLayout title="Accomplishment Review" description="Review and endorse employee accomplishment submissions">
                    ...
                    return (
                        <div key={s.id} onClick={() => router.visit(`/dept-head/accomplishment-review/${s.id}`)}
                            ...
                            <div style={{ flex: 1, minWidth: 0 }}>
                                ...
                                <div style={{ fontSize: '0.72rem', color: 'var(--admin-text-muted)', marginTop: 2, display: 'flex', alignItems: 'center', gap: 8 }}>
