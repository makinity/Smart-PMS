...
const statusStyle = s => ({
    ...
    ...(s === 'draft'        ? { background: 'rgba(234,179,8,0.15)',   color: '#facc15',             borderColor: 'rgba(234,179,8,0.35)' }   :
                            ...
                            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.875rem' }}>
                                <thead>
                                    <tr style={{ borderBottom: '1px solid var(--admin-border-strong)' }}>
                                        {['Period', 'Office', 'Status', 'Last Updated', ''].map(col => (
                                ...
                                <tbody>
                                    {uwps.map(uwp => (
                                        <tr key={uwp.id} style={{ borderBottom: '1px solid var(--admin-border)' }}>
                                            ...
                                            <td style={td}><span style={statusStyle(uwp.status)}>{uwp.status?.replace(/_/g, ' ')}</span></td>
...
const btnPrimary = { padding: '0.5rem 1.1rem', borderRadius: 8, background: 'var(--admin-accent)', color: '#fff', fontSize: '0.82rem', fontWeight: 600, border: 'none', cursor: 'pointer' };
