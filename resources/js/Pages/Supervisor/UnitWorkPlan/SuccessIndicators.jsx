...
export default function Index() {
    return (
        <AppLayout title="Success Indicators">
            <div style={card}>
                ...
                <h4 style={h}>Success Indicators</h4>
                <p style={p}>Define and manage the success indicators for your unit work plan outputs.</p>
