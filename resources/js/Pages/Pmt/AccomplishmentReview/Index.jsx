    ...
    return (
        <div onClick={() => router.visit(`/pmt/accomplishment-review/${s.id}`)}
            style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.85rem 1rem',
                ...
                borderLeft: `3px solid ${s.dept_head_flagged_for_calibration ? '#a78bfa' : pending ? '#f59e0b' : sc.c}`,
            ...
            <div style={{ ...card, padding: '1.25rem' }}>
                ...
                {flagged.length > 0 && (
                    <>
                        ...
                        <div style={{ padding: '0.75rem', marginBottom: '0.5rem', borderRadius: 10, background: 'rgba(167,139,250,0.06)', border: '1px solid rgba(167,139,250,0.2)' }}>
                            ...
                            {flagged.map(s => <SubmissionRow key={s.id} s={s} />)}
                        </div>
                    </>
                )}
                ...
                {standard.length > 0 && (
                    <>
                        ...
                        {standard.map(s => <SubmissionRow key={s.id} s={s} />)}
                    </>
                )}
                ...
                {processed.length > 0 && (
                    <>
                        ...
                        {processed.map(s => <SubmissionRow key={s.id} s={s} />)}
                    </>
                )}
            </div>
        </AppLayout>
