...
export default function Index() {
    return (
        <AppLayout title="Employee Calibration Details">
            <div style={card}>
                ...
                <h4 style={h}>Employee Calibration Details</h4>
                <p style={p}>Review and finalize calibration for a specific employee.</p>
