...
export default function Index() {
    return (
        <AppLayout title="Development Planning">
            <div style={card}>
                ...
                <h4 style={h}>Development Planning</h4>
                <p style={p}>Manage individual development plans linked to performance outcomes.</p>
                        <div style={{badgesStyle}}><span style={{badgeStyle}}>IDP</span>
                        <span style={{badgeStyle}}>Stage 4</span></div>
