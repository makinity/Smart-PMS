...
export default function Index() {
    return (
        <AppLayout title="Top Performers">
            <div style={card}>
                ...
                <h4 style={h}>Top Performers</h4>
                <p style={p}>View and recognize top-performing employees for the current period.</p>
                        <div style={{badgesStyle}}><span style={{badgeStyle}}>Recognition</span>
