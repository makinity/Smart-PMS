    ...
    return (
        <AppLayout title="PMT Dashboard">
            <div style={card}>
                ...
                <h4 style={h}>PMT Dashboard</h4>
                <p style={p}>Manage OPCR reviews, calibration, development planning, and top performer recognition across the organization.</p>
                <div style={badgesStyle}>
                        <span style={badgeStyle}>Stage 1</span>
                        <span style={badgeStyle}>Stage 2</span>
                        <span style={badgeStyle}>Stage 3</span>
                        <span style={badgeStyle}>Stage 4</span>
                </div>
            </div>
        </AppLayout>
    );
