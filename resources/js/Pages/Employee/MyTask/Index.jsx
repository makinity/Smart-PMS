...
export default function Index() {
    return (
        <AppLayout title="My Tasks">
            <div style={card}>
                <div style={iconBox}><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="var(--admin-accent)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg></div>
                <h4 style={h}>My Tasks</h4>
                <p style={p}>Track your assigned tasks synced from the unit work plan and performance targets.</p>
                        <div style={{badgesStyle}}><span style={{badgeStyle}}>Tasks</span>
                        <span style={{badgeStyle}}>Planning</span></div>
