                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '0.75rem' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.85rem', minWidth: 0 }}>
                            ...
                            <div style={{ minWidth: 0 }}>
                                {bp !== 'mobile' && <h1 style={{ fontWeight: 700, fontSize: '1.4rem', color: 'var(--admin-text-primary)', lineHeight: 1.1 }}>MPOR</h1>}
                            </div>
                        </div>
                        ...
                        <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center', flexShrink: 0 }}>
                            ...
                            {canSubmit ? (
                                <button onClick={handleSubmit} disabled={submitting} style={{ ...btnPrimary, opacity: submitting ? 0.7 : 1 }} title="Submit MPOR">
                                    ...
                                    {bp !== 'mobile' && bp !== 'tablet' && <span>{submitting ? 'Submitting…' : 'Submit'}</span>}
                                </button>
                            ) : null}
                        </div>
                    </div>
