    ...
    return (
        <AppLayout title="Audit Logs">
            <div style={card}>
                ...
                <h4 style={h}>Audit Logs</h4>
                <p style={p}>View a full trail of system activity — who did what and when.</p>
                        <div style={{badgesStyle}}><span style={{badgeStyle}}>Monitoring</span>
                        <span style={{badgeStyle}}>Security</span></div>
