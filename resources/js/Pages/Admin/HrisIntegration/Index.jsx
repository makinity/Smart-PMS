...
export default function Index() {
    return (
        <AppLayout title="HRIS Integration">
            <div style={card}>
                <div style={iconBox}><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="var(--admin-accent)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg></div>
                <h4 style={h}>HRIS Integration</h4>
                <p style={p}>Sync employee data from the HMS/HRIS system into the PMS.</p>
                        <div style={{badgesStyle}}><span style={{badgeStyle}}>Sync</span>
                        <span style={{badgeStyle}}>Integration</span></div>
