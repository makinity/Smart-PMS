...
export default function Index() {
    return (
        <AppLayout title="Reports">
            <div style={card}>
                <div style={iconBox}><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="var(--admin-accent)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><line x1="10" y1="9" x2="8" y2="9"/></svg></div>
                <h4 style={h}>Reports</h4>
                <p style={p}>Generate and export system-wide performance reports across all roles and periods.</p>
                        <div style={{badgesStyle}}><span style={{badgeStyle}}>Export</span>
                        <span style={{badgeStyle}}>Analytics</span></div>
