...
export default function Index() {
    return (
        <AppLayout title="Performance Periods">
            <div style={card}>
                <div style={iconBox}><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="var(--admin-accent)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/></svg></div>
                <h4 style={h}>Performance Periods</h4>
                <p style={p}>Define and manage performance rating cycles and evaluation timelines.</p>
                        <div style={{badgesStyle}}><span style={{badgeStyle}}>Periods</span>
                        <span style={{badgeStyle}}>Scheduling</span></div>
